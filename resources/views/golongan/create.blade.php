...
<div class="mx-auto my-10">
    ...
    <form action="/golongan" method="POST">
      ...
      <div class="form-group mb-6 ">
        <h1 class="flex justify-center mb-5 text-white font-bold">Create Golongan</h1>
        <label for="id" class="form-label inline-block mb-2 text-gray-500">ID Golongan</label>
        <input required value="{{ old('id') }}" name="id" type="text" class="form-control
          block
          w-full
          px-3
          py-1.5
      ...
      <div class="form-group mb-6 ">
        ...
        <input required value="{{ old('nama_golongan') }}" name="nama_golongan" type="text" class="form-control
          block
          w-full
          px-3
          py-1.5
